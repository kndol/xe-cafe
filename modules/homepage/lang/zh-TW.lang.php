<?php
    ...
    $lang->about_cafe_creation_type = "請選擇用戶可訪問的網站。選擇網站 ID 的話，可透過「http://網址/ID」訪問；選擇網域名稱，則可透過已註冊的域名的子域名訪問「http://子域名.網域名稱」";
    ...
    $lang->about_allow_service = '可設定新建立的網站基本數量和可使用的功能。';
    ...
    $lang->about_cafe_main_mid = '網站的網址為「http://網址/<b>ID</b>」，請輸入想要的 ID 值。';
    ...
    $lang->about_cafe_act = array(
        ...
        "dispHomepageCounter" => "可以檢視網站的訪問數據統計。",
        "dispHomepageMidSetup" => "可詳細設定網站所使用的討論板，頁面等模組",
    );
    $lang->about_cafe = "此模組可快速建立網站，且設定簡單。";
    ...
    $lang->msg_module_type_setting = '尚未選擇模組類型';
?>
